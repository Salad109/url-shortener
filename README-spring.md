> **ARCHIVED.** This file documents the original Spring Boot + Redis implementation, superseded by the Go rewrite.
> Everything below describes the codebase tagged `spring-final`
> at https://github.com/Salad109/url-shortener/tree/spring-final
>
> Consider it an engineering log, not a reproducible setup.
...
See [`test.http`](https://github.com/Salad109/url-shortener/blob/spring-final/test.http) for example requests you can
run directly.
...
I chose Protocol buffers because despite the setup complexity, the code is simple and readable, while still being much
more efficient than JSON. Keeping track of all KV pairs and their TTLs manually was becoming too complicated, so I
...
![Dashboard screenshot](https://raw.githubusercontent.com/Salad109/url-shortener/spring-final/grafana/dashboard.webp)
